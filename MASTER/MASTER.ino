...
void leituraDeDados() {
  temperaturalocal = dht.readTemperature(); // Obtém os valores da temperatura
  umidadelocal = dht.readHumidity(); // Obtém os valores da umidade
}
...
//setando os valores para envio
  ...
  dadosSensor1.temperatura = temperaturalocal;
  dadosSensor1.umidade = umidadelocal;

  leituraDeDados();
  Serial.println("-----------------------------------------------------------");
  Serial.println("-----------------------------------------------------------");
  Serial.print(umidadelocal);
  Serial.println("%");
  Serial.print(temperaturalocal);
  Serial.println("ºC");
  Serial.println("-----------------------------------------------------------");
  Serial.println("-----------------------------------------------------------");
